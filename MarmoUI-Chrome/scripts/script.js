...
function runMarmoUI()
{
	...
	function applyChangesAll(current_page)
	{
		...
		function changepicture(){
			cur ++;
			cur = cur % backgrounds.length;
			$("body").css('background-image', backgrounds[cur]);
		}
		//var current_image = Math.floor(Math.random() * 4);;
		$("body").click(changepicture);
		//var timer = 2000;
		//setInterval(changepicture, timer);
